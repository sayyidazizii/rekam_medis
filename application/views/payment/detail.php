<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>Payment/update_rekam_medis" method="post">
        <div class="container mt-2"> 
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td><input type="text" name="tanggal_pembayaran" id="tanggal_pembayaran" value="<?= $data_pembayaran->tanggal_pembayaran ?>" class="form-control my-1" readonly></td>
                </tr>
                <tr>
                    <th>Tindakan</th>
        ...
        <table style="width: 100%">
                ...
                <tr>
                    <th>Bayar</th>
                    <td><input type="number" name="bayar" id="bayar"  class="form-control my-1"  readonly></td>
                </tr>
                <tr>
                    <th>Kembalian</th>
