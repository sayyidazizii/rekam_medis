        ...
        <div class="col">
            <form action="<?= base_url() ?>obat" method="get">
                <div class="d-flex flex-nowrap input-group mb-3">
                    <input type="text" class="form-control border-dark" placeholder="Cari obat" name="data_obat" style="width: 100%; max-width: 300px;" value="<?php if ($pencarian != null) {
                                                                                                                                                                    echo $pencarian;
                                                                                                                                                                } ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-nowrap">
                                ...
                                <!-- Tombol Hapus -->
                                <a href="<?= base_url() ?>obat/hapus_obat/<?= $obat->id_data_obat ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="ti ti-trash"></i></a>
