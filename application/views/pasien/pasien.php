        ...
        <div class="col">
            <form action="<?= base_url() ?>pasien" method="get">
                <div class="d-flex flex-nowrap input-group mb-3">
                    <input type="text" class="form-control border-dark" placeholder="Cari pasien" name="data_pasien" style="width: 100%; max-width: 300px;" value="<?php if ($pencarian != null) {
                                                                                                                                                                        echo $pencarian;
                                                                                                                                                                    } ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-nowrap">
                                ...
                                <a href="<?= base_url() ?>pasien/hapus_pasien/<?= $pasien->id_pasien ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="ti ti-trash"></i></a>
                            </div>
                        </td>
                    </tr>
