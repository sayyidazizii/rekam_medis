        ...
        <div class="container mt-2"> 
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td><input type="date" name="tanggal_periksa" id="tanggal_periksa" class="form-control my-2 border-dark" value="<?= $data_rekam_medis->tanggal_periksa ?>"></td>
                </tr>
                <tr>
                    <th>Amnesa</th>
                    <td><input type="text" name="amnesa" id="amnesa" class="form-control my-2 border-dark" value="<?= $data_rekam_medis->amnesa ?>"></td>
                </tr>
                <tr>
                    <th>Diagnosa</th>
                    <td><input type="text" name="diagnosa" id="diagnosa" class="form-control my-2 border-dark" value="<?= $data_rekam_medis->diagnosa ?>"></td>
                </tr>
                <tr>
                    <th>Tindakan</th>
                    <td><input type="text" name="tindakan" id="tindakan" class="form-control my-2 border-dark" value="<?= $data_rekam_medis->tindakan ?>"></td>
                </tr>
            </table>
            <hr>
