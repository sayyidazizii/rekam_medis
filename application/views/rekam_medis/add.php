    ...
    <form action="<?= base_url() ?>RekamMedis/simpan_rekam_medis" method="post">
        <div class="container mt-2"> 
            ...
            <div class="row">
                ...
                <div class="col">
                    <select class="form-control js-example-basic-single" name="id_data_tarif">
                            <option value="0">-- Pilih data --</option>
            ...
            <div class="row">
                <div class="col"></div>
                    <div class="col"><button type="button" id="add-jasa" class="btn btn-primary my-1 mb-2">Tambah Jasa</button></div>
            </div>

            <div class="row">
                <div class="col">Obat</div>
                <div class="col">
                    <select class="form-control js-example-basic-single" name="id_data_obat">
                            <option value="0">-- Pilih data --</option>
            ...
            <div class="row">
                ...
                <div class="col">
                    <input type="text" name="stock_quantity" id="stock_quantity" class="form-control my-1"> 
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col"></div>
                    <div class="col"><button type="button" id="add-obat" class="btn btn-primary my-1">Tambah obat</button></div>
            </div>
        </div>
        <hr>
        <div class="row">
